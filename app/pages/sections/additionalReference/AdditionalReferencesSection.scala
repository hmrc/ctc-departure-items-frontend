...
case class AdditionalReferencesSection(itemIndex: Index) extends AddAnotherSection {

  override def path: JsPath = ItemSection(itemIndex).path \ toString

  override def toString: String = "additionalReferences"

  override val addAnotherPage: AddAnotherPage = AddAnotherAdditionalReferencePage(itemIndex)
}
