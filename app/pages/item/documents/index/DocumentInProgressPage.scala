...
case class DocumentInProgressPage(itemIndex: Index, documentIndex: Index) extends QuestionPage[Boolean] {

  override def path: JsPath = DocumentSection(itemIndex, documentIndex).path \ toString

  override def toString: String = "documentInProgress"
  ...
  def reader: Read[Boolean] =
    DocumentInProgressPage(itemIndex, documentIndex).optionalReader.to {
