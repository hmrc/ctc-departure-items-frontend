...
case class AdditionalInformationPage(itemIndex: Index, additionalInformationIndex: Index) extends QuestionPage[String] {

  override def path: JsPath = AdditionalInformationSection(itemIndex, additionalInformationIndex).path \ toString

  override def toString: String = "addaAdditionalInformation"
