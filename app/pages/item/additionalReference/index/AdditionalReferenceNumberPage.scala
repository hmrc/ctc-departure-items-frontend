...
case class AdditionalReferenceNumberPage(itemIndex: Index, additionalReferenceIndex: Index) extends QuestionPage[String] {
  ...
  override def route(userAnswers: UserAnswers, mode: Mode): Option[Call] =
    Some(routes.AdditionalReferenceNumberController.onPageLoad(userAnswers.lrn, mode, itemIndex, additionalReferenceIndex))
}
