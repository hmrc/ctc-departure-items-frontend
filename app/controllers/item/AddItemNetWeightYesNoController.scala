...
class AddItemNetWeightYesNoController @Inject() (
  ...
  view: AddItemNetWeightYesNoView
      ...
      form
        ...
        .fold(
          ...
          value => {
            ...
            AddItemNetWeightYesNoPage(itemIndex).writeToUserAnswers(value).updateTask().writeToSession(sessionRepository).navigateWith(navigator)
          }
        )
  }
}
