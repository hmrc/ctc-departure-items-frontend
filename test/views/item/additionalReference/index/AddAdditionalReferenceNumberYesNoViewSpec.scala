...
class AddAdditionalReferenceNumberYesNoViewSpec extends YesNoViewBehaviours {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector.instanceOf[AddAdditionalReferenceNumberYesNoView].apply(form, lrn, NormalMode, itemIndex, additionalReferenceIndex)(fakeRequest, messages)

  override val prefix: String = "item.additionalReference.index.addAdditionalReferenceNumberYesNo"
