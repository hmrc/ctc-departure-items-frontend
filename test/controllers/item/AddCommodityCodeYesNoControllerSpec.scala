...
class AddCommodityCodeYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {

  private val formProvider                    = new YesNoFormProvider()
  private val form                            = formProvider("item.addCommodityCodeYesNo")
  private val mode                            = NormalMode
  private lazy val addCommodityCodeYesNoRoute = routes.AddCommodityCodeYesNoController.onPageLoad(lrn, mode, itemIndex).url
  ...
  "AddCommodityCodeYesNo Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(AddCommodityCodeYesNoPage(itemIndex), true)
