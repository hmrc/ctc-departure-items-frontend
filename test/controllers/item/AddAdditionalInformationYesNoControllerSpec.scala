...
import views.html.item.AddAdditionalInformationYesNoView
...
class AddAdditionalInformationYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {
  ...
  private val form                                    = formProvider("item.addAdditionalInformationYesNo")
  private val mode                                    = NormalMode
  private lazy val addAdditionalInformationYesNoRoute = routes.AddAdditionalInformationYesNoController.onPageLoad(lrn, mode, itemIndex).url
  ...
  "AddAdditionalInformationYesNo Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(AddAdditionalInformationYesNoPage(itemIndex), true)
